...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import hsakmt_roct_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1cecccd7-a9b6-5045-9cdc-a44c19b16d76"))
platforms = [Pkg.Artifacts.unpack_platform(e, "hsakmt_roct", artifacts_toml) for e in artifacts["hsakmt_roct"]]
...
if best_platform === nothing
    @debug("Unable to load hsakmt_roct; unsupported platform $(triplet(platform_key_abi()))")
else
